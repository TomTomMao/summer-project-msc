...
def updateUniqueKey(frequencyUniqueKey: FrequencyUniqueKey,  per: Literal['month', 'day'], metric1: str, metric2: str, numberOfCluster: int, distanceMeasure: Union[DistanceMeasure, None] = None, linkageMethod: Union[LinkageMethod, None] = None, numberOfClusterForString: Union[int, None] = None):
