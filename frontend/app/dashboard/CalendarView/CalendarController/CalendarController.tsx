...
export function CalendarController({ year, handleSetYear, mappings , transactionVariables}:
    { year: string, handleSetYear: (year: string) => void, mappings: IMapping[] ,transactionVariables:ETransactionVariable[]}) {
    return (
        <div className='p-1 bg-gray-400 w-48'>
            ...
            <div className='bg-blue-200 mb-1'>
                <MappingController mappings={mappings} transactionVariables={transactionVariables}></MappingController>
            </div>
